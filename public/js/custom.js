...
// 	from = $( "#pick-up-date-input" )
// 		.datepicker()
// 		.on( "change", function() {
// 			to.datepicker( "option", "minDate", getDate( this ) );
// 		}),
// 	to = $( "#drop-off-date-input" ).datepicker()
// 	.on( "change", function() {
...
return date;
	...
	// $( "#pick-up-date-input" ).datepicker();
	// $( "#drop-off-date-input" ).datepicker();
	...
	$(".form").submit(function(e){
		...
		var formError = $('.error-form',this)

		$('input[data-type=text]', this).each(function(){
			if($(this).val() == '') {
		...
		$('input[data-type=email]', this).each(function(){
		...
		// $('input[data-type=number]', this).each(function(){			
		...
		$('input[data-type=date]', this).each(function(){	
		...
		$('input,select').change(function(){
			if($(this).val() != '') {
				$(this).parents('.reservation-form__field-inner').removeClass('error');
				formError.slideUp(200);
			}
		});
		if(errors.length == 0){
			var formBody = 	$('.form-body',this)
			var success_msg = 	$('.form-success-message',this)
			formError.slideUp(200);
...
jQuery(function($){
	...
	function reserve_form_init() {
		...
		// 		});
		// 	}
		// 	$('#reservation-form__pick-up-date-input').datepicker();
		// 	dpArgs.onSelect=null;
		// 	$('#reservation-form__drop-off-date-input').datepicker();
		// }
